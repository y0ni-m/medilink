  ...
  return (
    <div className="page">
      ...
      >
        ...
        <p>MediLink will ensure that any Subcontractor that creates, receives, maintains, or transmits PHI on its behalf agrees in writing to restrictions and conditions at least as protective as those in this BAA. MediLink&apos;s current subprocessors are listed at <strong>medilink.vip/subprocessors</strong> (also in `compliance/legal/subprocessors.md`); MediLink will update that list before adding a subprocessor that handles PHI.</p>
