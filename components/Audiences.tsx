...
const CARDS = [
  {
    ...
    desc: 'Match clients to specialists by geography, treatment type, and capacity — all with credentialed providers and signed LOPs / Patient financial responsibility in a single timeline.',
    bullets: [
      'Verified clinics with NPI + malpractice coverage',
      'Auto-generated LOPs / Patient financial responsibility and intake packets',
  ...
  },
  {
    ...
    desc: 'Receive PI cases that match your specialty and coverage area — with transparent attorney info, automated LOPs / Patient financial responsibility routing, and clean settlement payouts.',
    bullets: [
