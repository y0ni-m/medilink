...
const CARDS = [
  {
    ...
    desc: 'Match clients to specialists by geography, treatment type, and capacity — all with credentialed providers and signed LOP and/or Patient financial responsibility depending on what state you are operating in in a single timeline.',
    bullets: [
      'Verified clinics with NPI + malpractice coverage',
      'Auto-generated LOP and/or Patient financial responsibility depending on what state you are operating in and intake packets',
